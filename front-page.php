                    ...
                    <div class="module-Style_Item">
                        <a href="#" class="module-Style_Item_Link" title="メンズパーマ">
                            <figure class="module-Style_Item_Img">
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>./assets/img/hairstyle4.png"
                                    alt="">
                            </figure>
                        </a>
                    </div>
                ...
                <div class="col-6 col-md-3">
                    <div class="module-Style_Item">
                        <a href="#" class="module-Style_Item_Link" title="前髪ありキュートボブ">
                            <figure class="module-Style_Item_Img">
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>./assets/img/hairstyle3.png"
                                    alt="">
                            </figure>
                        </a>
                    </div>
                ...
                <div class="col-6 col-md-3">
                    <div class="module-Style_Item">
                        <a href="#" class="module-Style_Item_Link" title="メンズカット">
                            <figure class="module-Style_Item_Img">
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>./assets/img/hairstyle2.png"
                                    alt="">
                            </figure>
                        </a>
                    </div>
                ...
                <div class="col-6 col-md-3">
                    <div class="module-Style_Item">
                        <a href="#" class="module-Style_Item_Link" title="大人ミディアム">
                            <figure class="module-Style_Item_Img">
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>./assets/img/hairstyle1.png"
                                    alt="">
                            </figure>
                        </a>
                    </div>
